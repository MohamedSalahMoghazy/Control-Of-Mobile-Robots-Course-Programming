...
%             obj.add_surface_with_alpha(qb_axle, [0.15 0.15 0.15], 0.5);
        ...
        function ir_distances = get_ir_distances(obj)
            ...
            ir_voltages_from_table=[0.04,0.05,0.06,0.07,0.08,0.09,0.10,0.12,0.14,0.16,0.18,0.20,0.25,0.30]
            ir_distances_from_table=[2.750,2.350,2.050,1.750,1.550,1.400,1.275,1.075,0.925,0.805,0.725,0.650,0.500,0.400]
            coeff = [ -1.0749  1.0994 -0.4448 0.0907 -0.0098  0.0005 ];
